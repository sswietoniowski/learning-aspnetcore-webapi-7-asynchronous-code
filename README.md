...
Tasks are managed by a state machine (an implementation of `IAsyncStateMachine`) generated by the compiler when a method is marked with the `async` modifier.
